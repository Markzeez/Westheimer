...
import { Mail, Lock, User, Eye, EyeOff, AlertCircle, Package, CheckCircle } from 'lucide-react';
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-4 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
